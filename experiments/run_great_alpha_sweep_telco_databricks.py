%python
# Phase 5 α-sweep — GReaT on Telco Churn at small-n shoulder.
...
#
# Output: {WORK_DIR}/great_alpha_sweep_telco_results.csv
# Schema: n, seed, method, alpha, auc, error
#         Baseline rows have alpha=0.0.
#
# Run convention matches run_great_telco_databricks.py exactly except:
#   - SMALL_NS limited to {50, 100, 200} (small-n shoulder)
#   - ALPHAS sweep added
...
OUT_PATH  = f"{WORK_DIR}/great_alpha_sweep_telco_results.csv"
...
for n_train in SMALL_NS:
    ...
    for seed in SEEDS:
        ...
        try:
            ...
            ckpt_dir = "/tmp/great_alpha_ckpt_telco"
            ...
            # α-sweep: same GReaT fit, subsample synthetic per α
            for alpha in ALPHAS:
