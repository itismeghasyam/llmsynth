...
1. **α=1.0 is never optimal** — across nine (dataset, n) cells, the best α is 0.1 (4 cells), 0.2 (3 cells), 0.3 (2 cells), and 1.0 (1 cell). This mirrors the §6.3 statistical-generator finding and means **the §6.6 α=1.0 main-table evaluations systematically understate GReaT's potential**.
...
- GReaT α\* < 1.0 universally — α=0.1 to 0.3 is consistently better than α=1.0.
